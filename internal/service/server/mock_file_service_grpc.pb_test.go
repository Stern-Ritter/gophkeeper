...
//
//	mockgen -source=./proto/gen/gophkeeper/gophkeeperapi/v1/file_service_grpc.pb.go -destination ./internal/service/server/mock_file_service_grpc.pb_test.go -package server
//
