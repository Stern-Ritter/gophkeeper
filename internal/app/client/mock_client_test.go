...
//
//	mockgen -source=./internal/service/client/client.go -destination ./internal/app/client/mock_client_test.go -package client
//
...
func (m *MockClient) SetAccountService(accountService client.AccountService) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SetApp(app client.Application) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SetAuthService(authService client.AuthService) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SetCardService(cardService client.CardService) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SetFileService(fileService client.FileService) {
	m.ctrl.T.Helper()
...
func (m *MockClient) SetTextService(textService client.TextService) {
	m.ctrl.T.Helper()
